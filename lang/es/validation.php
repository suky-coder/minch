...
return [
    ...
    'attributes' => [
        ...
        'place' => 'lugars',
        'sport' => 'deporte',
        'address_home' => 'domicilio',
        'address_number' => 'número de domicilio',
        'zone_home' => 'zona',
        'enrollment_conalab' => 'matricula CONALAB',
        'enrollment_rpa' => 'matricula RPA',
        'profession' => 'profesión',
        'profession_status' => 'estado de profesión',
        'address_office' => 'domicilio procesal',
        'address_number' => 'número de domicilio',
        'zone' => 'zona',
        'amount' => 'monto',
        ...
        'level' => 'nivel de cargo',
        'phone' => 'telefono',
        'title' => 'titulo',
        'complainant' => 'denunciante',
        'quantity' => 'cantidad',
        'affiliate_id' => 'matricula',
        'mausoleum' => 'mausoleo',
        ...
        'specialtiesArray.*.university_id' => 'universidad de especialidad',
        'social.*.type' => 'tipo de plataforma digital',
        'social.*.url' => 'dirección de plataforma digital',
    ],
];
